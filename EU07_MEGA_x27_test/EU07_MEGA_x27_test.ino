...
void manometry_x25()  {
  ...
  //motor1.setPosition(map(zPC_TankPress, 0, 255, 0, 696)); // zbiornik glowny
  //motor1.setPosition(map(zPC_PipePress, 0, 255, 0, 400)); // przewod glowny
  //motor1.setPosition(map(zPC_BrakePress, 0, 255, 0, 400)); // przewod glowny
...
/*
void mierniki_down() {
// Obnizenie wskazan miernikow aby nie walily wskazowkami przy wylaczeniu
 
  // Cylinder hamulcowy
    analogWrite(pinMCH, 35);
  
  // Przewod glowny
    analogWrite(pinMPG, 35);

  // Zbiornik glowny
    analogWrite(pinMZG, 35);
}
*/
void debug_monitor()  {
